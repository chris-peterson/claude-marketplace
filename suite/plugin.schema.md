...
| `events.publishes` | the event catalog | Events this plugin announces, declared in full: bare `key`, `when` prose, `emitted_by`, and `fields`. See [the events contract](../authoring/plugin-contract.md#declaring-events). |
